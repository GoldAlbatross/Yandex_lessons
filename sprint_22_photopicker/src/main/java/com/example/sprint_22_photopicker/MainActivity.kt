package com.example.sprint_22_photopicker
...
import com.example.sprint_22_photopicker.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loadImageFromStorage.setOnClickListener {
            val filePath = File(this.getExternalFilesDir(Environment.DIRECTORY_PICTURES), "myalbum")
